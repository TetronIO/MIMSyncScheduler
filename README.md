...
Note: The Scheduler may receive SQL deadlock responses from MIM if it is busy performing another operation whilst trying to do something. This is a normal MIM error and the scheduler will gracefully handle this by re-trying the operation.
